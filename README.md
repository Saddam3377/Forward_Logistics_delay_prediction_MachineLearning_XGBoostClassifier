...
Dispatch Warehouse,	SC Code, SC Status, Destination Pincode, Courier Assign,	Dispatch Dt, Mode, In-Transit Aging, Avg_IntransitAging, delay_rate_AT_sc_code, delay_rate_AT_pincode, Target
