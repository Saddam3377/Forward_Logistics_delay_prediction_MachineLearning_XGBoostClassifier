...
import pandas as pd
df = pd.read_excel("D:\\Users\\V63737270\\Downloads\\New folder\\Forward_train_rawData.xlsx")
...
cat_cols = ['Dispatch Wh', 'SC_code'  , 'Dst Pincode','ODA','State','Region','Mode', 'Courier Align']
...
##Displaying Confusion matrix by using heatmap for better understanding of my model performance
...
## Displaying ROC curve for better understanding of my model performance
